...
const Admin = ({ currentUser }) => {
  ...
  const renderUser = (user, index) => {
    return <section key={"local-user-"+index} className="grid grid-cols-9 py-1.5 border-b-2 border-slate-50 text-sm">
      ...
      <section className="col-span-3 flex flex-col justify-center items-start">
        <Button 
          type="button"
          onClick={() => setIsModalOpen({ show: true, data: user })} 
  ...
  return (<>
    <Head>
      <title>FELE Admin Local Users</title>
      ...
      <main className="col-span-8">
        <article className="">
          ...
          <section className="py-2 px-4">
            <section className="grid grid-cols-9 font-semibold py-1.5 border-b-2 border-slate-100 text-sm">
